...
BOT_TOKEN = environ.get('BOT_TOKEN', '5048328047:AAHj2_1iRCJi7pxO1OYMw34pgSGSHurajsQ')
...
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/bbabccf5c436689ccc9b9.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/2a888a370f479f4338f7c.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1654009706').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HeavenBotSupport')
